# Generated by Django 3.0.7 on 2020-06-20 21:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(blank=True, choices=[(0, 'Aguardando Pagamento'), (1, 'Concluida'), (0, 'Cancelada')], default=0, verbose_name='Situação')),
                ('payment', models.CharField(choices=[('pagueseguro', 'PagueSeguro'), ('paypal', 'PayPal')], max_length=20, verbose_name='Opção de Pagamento')),
